        ...
        <main v-else class="pack-list">
            ...
            <div class="level-container">
                <div class="level" v-if="selectedPackLevels[selectedLevel][0]">
                    ...
                    <h2>Records</h2>
                    <p v-if="selected + 1 <= 150"> <strong> Necesitas un </strong> <strong>{{ selectedPackLevels[selectedLevel][0].level.percentToQualify }}%</strong> o más para calificar</p>
                    <p v-else>Necesitas un 100% para calificar</p>
                    <table class="records">
            ...
            <div class="meta-container">
                <div class="meta">
                    ...
                    <h3>Acerca de los packs</h3>
                    <p>
                        Estos packs contienen demons elejidos por el staff y si los completas lo tendrás como logro en tu usuario.
                    </p>
                    <h3>Cómo puedo obtener los packs?</h3>
                    <p>
                        Puedes obtenerlos completandolos.
                    </p>
                    <p> El creador de los packs es KrisGra.</p>
                </div>
            </div>
        </main>
    `,
